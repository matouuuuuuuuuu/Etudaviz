<?php
    $title = "Politique de confidentialité - Etudaviz";
...
<section class="privacy">
    ...
    <p>Ce site est édité dans le cadre d’un projet étudiant.<br>
    Responsable de publication : [Dihya Mokri, Loris Beguin, Léa Bonacorsi, Mathis Albrun].</p>
    ...
    <ul>
        ...
        <li>Informations fournies volontairement via un formulaire de contact (nom, prénom, email, message).</li>
    </ul>
